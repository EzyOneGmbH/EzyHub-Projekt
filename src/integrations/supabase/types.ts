  ...
  public: {
    Tables: {
      ...
      ai_opportunity_states: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_opportunity_states_client_id_fkey";
            columns: ["client_id"];
            isOneToOne: false;
            referencedRelation: "clients";
            referencedColumns: ["id"];
      ...
      first_party_sync_status: {
        Row: {
          auth_art: string | null;
          backfill_bis: string | null;
          backfill_ziel: string | null;
          client_id: string;
          letzter_erfolg_at: string | null;
        ...
        Relationships: [
          {
            foreignKeyName: "first_party_sync_status_client_id_fkey";
            columns: ["client_id"];
            isOneToOne: false;
            referencedRelation: "clients";
            referencedColumns: ["id"];
      ...
      ga4_landing_daily: {
        ...
        Relationships: [
          {
            foreignKeyName: "ga4_landing_daily_client_id_fkey";
            columns: ["client_id"];
            isOneToOne: false;
            referencedRelation: "clients";
            referencedColumns: ["id"];
      ...
      gsc_daily: {
        ...
        Relationships: [
          {
            foreignKeyName: "gsc_daily_client_id_fkey";
            columns: ["client_id"];
            isOneToOne: false;
            referencedRelation: "clients";
            referencedColumns: ["id"];
    ...
    kpi_chancen_keywords: {
      Args: {
        ...
        _pos_von?: number;
        _von: string;
        _zielposition?: number;
      };
      Returns: {
        clicks: number;
        ctr: number;
        ctr_luecke: number;
        erwartete_ctr: number;
        impressions: number;
        pos: number;
        potenzial_klicks: number;
        query: string;
        score: number;
        seiten: number;
        top_page: string;
    ...
    kpi_datenstand: {
      Args: { _client_id: string };
      Returns: { bis: string; quelle: string; von: string; zeilen: number }[];
    };
    kpi_gewinner_verlierer: {
      Args: { _bis: string; _client_id: string; _limit?: number; _von: string };
      Returns: {
        clicks: number;
        clicks_vorher: number;
        delta_clicks: number;
        delta_impressions: number;
        impressions: number;
        impressions_vorher: number;
        page: string;
        pos: number;
        pos_vorher: number;
        richtung: string;
...
export const Constants = {
  public: {
    Enums: {
      ...
      audit_status: ["pending", "running", "succeeded", "failed"],
      content_status: ["draft", "review", "published", "archived"],
      content_type: ["blog", "landing", "geo", "social", "other", "audit", "note", "report", "win"],
      org_role: ["owner", "admin", "member", "viewer"],
      task_priority: ["low", "medium", "high"],
      task_status: ["open", "in_progress", "done"],
    },
