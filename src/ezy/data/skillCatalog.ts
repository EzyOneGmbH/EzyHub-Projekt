...
export const SKILL_CATALOG: SkillCatalogEntry[] = [
  ...
  },
  {
    ...
    category: "skills-seo",
    description:
      "Generate competitive SEO content briefs with per-section word counts, competitor scoring, keyword density guidance, and page-type templates.",
    note: null,
  },
  {
  ...
  },
  {
    ...
    category: "skills-seo",
    description:
      "E-commerce SEO analysis: Google Shopping visibility, Amazon marketplace intelligence, product schema validation, competitor pricing analysis, and marketplace ke",
    note: "benötigt DataForSEO",
  },
  {
    id: "skill:seo-flow",
  ...
  },
  {
    ...
    category: "skills-seo",
    description:
      "Google SEO APIs: Search Console (Search Analytics, URL Inspection, Sitemaps), PageSpeed Insights v5, CrUX field data with 25-week history, Indexing API v3, and",
  ...
  },
  {
    ...
    category: "skills-seo",
    description:
      "Local SEO analysis covering Google Business Profile optimization, NAP consistency, citation health, review signals, local schema markup, location page quality,",
    note: "benötigt teilw. DataForSEO",
  },
  {
    id: "skill:seo-maps",
    ...
    category: "skills-seo",
    description:
      "Maps intelligence for local SEO — geo-grid rank tracking, GBP profile auditing via API, review intelligence across Google/Tripadvisor/Trustpilot, cross-platform",
    note: "benötigt DataForSEO",
  },
  {
    id: "skill:seo-page",
  ...
  },
  {
    ...
    category: "skills-seo",
    description:
      "Search Experience Optimization: reads Google SERPs backwards to detect page-type mismatches, derives user stories from search intent signals, and scores pages f",
    note: null,
  },
  {
    ...
    category: "skills-seo",
    description:
      "Technical SEO audit across 9 categories: crawlability, indexability, security, URL structure, mobile, Core Web Vitals, structured data, JavaScript rendering, an",
    note: null,
  },
  {
    id: "skill:blog",
    ...
    description:
      "Full-lifecycle blog engine with 30 sub-skills, 12 content templates, 5-category 100-point scoring, and 5 specialized agents.",
    note: "langer Lauf",
  },
  {
    ...
    category: "skills-blog",
    description:
      "Audit and score blog posts on a 5-category 100-point scoring system covering content quality, SEO optimization, E-E-A-T signals, technical elements, and AI cita",
    note: null,
  },
  {
    id: "skill:blog-audio",
  ...
  },
  {
    ...
    category: "skills-blog",
    description:
      "Generate detailed content briefs for blog posts with target keywords, content outlines, competitive analysis, recommended statistics, image and chart suggestion",
    note: null,
  },
  {
    ...
    category: "skills-blog",
    description:
      "Generate editorial calendars for blogs with topic clusters, publishing schedules, content decay detection, freshness update plans, seasonal opportunities, conte",
    note: null,
  },
  {
  ...
  },
  {
    ...
    category: "skills-blog",
    description:
      "Research what people are actually saying about a topic in the last 30 days across Reddit, X / Twitter, YouTube, Hacker News, dev.to, Medium, and other public di",
    note: null,
  },
  {
  ...
  },
  {
    ...
    category: "skills-blog",
    description:
      "Google API integration for blog performance: PageSpeed Insights, CrUX Core Web Vitals with 25-week history, Search Console performance, URL Inspection, Indexing",
    note: "benötigt Google-API",
  },
  {
    id: "skill:blog-image",
  ...
  },
  {
    ...
    category: "skills-blog",
    description:
      "SERP-informed outline generation with H2/H3 heading hierarchy, competitive content gap analysis, section-by-section word count targets, chart and image placemen",
    note: null,
  },
  {
    ...
    category: "skills-blog",
    description:
      "Create and manage writing personas with NNGroup 4-dimension tone framework (Funny-Serious, Formal-Casual, Respectful-Irreverent, Enthusiastic-Matter-of-fact).",
    note: null,
  },
  {
  ...
  },
  {
    ...
    category: "skills-blog",
    description:
      "Rewrite and optimize existing blog posts for Google rankings (December 2025 Core Update, E-E-A-T) and AI citations (GEO/AEO).",
    note: null,
  },
  {
    ...
    category: "skills-blog",
    description:
      "Generate complete JSON-LD schema markup for blog posts including BlogPosting, Person, Organization, BreadcrumbList, FAQPage, and ImageObject.",
    note: null,
  },
  {
    ...
    category: "skills-blog",
    description:
      "Post-writing SEO validation with pass/fail checklist covering title tag length and keyword placement, meta description quality, heading hierarchy and keyword de",
    note: null,
  },
  {
    ...
    category: "skills-blog",
    description:
      "Blog strategy development including topic cluster architecture with hub-and-spoke design, audience mapping, competitive landscape analysis, AI citation surface",
    note: null,
  },
  {
  ...
  },
  {
    ...
    category: "skills-obsidian",
    description:
      "Visual layer of the wiki. Add images, text cards, PDFs, and wiki pages to Obsidian canvas files with auto-positioning inside zones. Integrates with /banana for",
    note: "lokaler Vault",
  },
  {
    id: "skill:defuddle",
  ...
  },
  {
    ...
    category: "skills-obsidian",
    description:
      "Create and edit Obsidian Bases (.base files): Obsidian's native database layer for dynamic tables, card views, list views, filters, formulas, and summaries over",
    note: "lokaler Vault",
  },
  {
    ...
    category: "skills-obsidian",
    description:
      "Write correct Obsidian Flavored Markdown: wikilinks, embeds, callouts, properties, tags, highlights, math, and canvas syntax.",
    note: null,
  },
  {
    id: "skill:save",
    ...
    category: "skills-obsidian",
    description:
      "Save the current conversation, answer, or insight into the Obsidian wiki vault as a structured note.",
    note: "lokaler Vault",
  },
  {
    id: "skill:think",
    ...
    category: "skills-obsidian",
    description:
      "Apply the 10-principle thinking loop (OBSERVE-OBSERVE-LISTEN-THINK-CONNECT-CONNECT-FEEL-ACCEPT-CREATE-GROW) to any non-trivial problem.",
    note: null,
  },
  {
    id: "skill:wiki",
  ...
  },
  {
    ...
    category: "skills-ads",
    description:
      "Full multi-platform paid advertising audit with parallel subagent delegation. Analyzes Google Ads, Meta Ads, LinkedIn Ads, TikTok Ads, Microsoft Ads, YouTube Ads, and Apple Ads.",
    note: "langer Lauf",
  },
  {
    id: "skill:ads-google",
    ...
    category: "skills-ads",
    description:
      "Google Ads deep analysis covering Search, Performance Max, AI Max, Display, YouTube, and Demand Gen campaigns. Evaluates 80 checks across 8 categories.",
    note: null,
  },
  {
    id: "skill:ads-meta",
    ...
    category: "skills-ads",
    description:
      "Meta Ads deep analysis covering Facebook, Instagram, and Threads advertising in the Andromeda + GEM + Lattice era. Evaluates 50 checks.",
    note: null,
  },
  {
    ...
    category: "skills-ads",
    description:
      "LinkedIn Ads deep analysis for B2B advertising. Evaluates 27 checks across technical setup, audience targeting, creative quality, lead gen.",
    note: null,
  },
  {
    id: "skill:ads-tiktok",
  ...
  },
  {
    ...
    category: "skills-ads",
    description:
      "Apple Ads (formerly Apple Search Ads) deep analysis for mobile app advertisers. Evaluates campaign structure, bid health, Custom Product Pages.",
    note: null,
  },
  {
    id: "skill:ads-amazon",
    ...
    category: "skills-ads",
    description:
      "Amazon Ads deep analysis covering Sponsored Products, Sponsored Brands, Sponsored Display, and DSP.",
    note: null,
  },
  {
  ...
  },
  {
    ...
    category: "skills-ads",
    description:
      "Budget allocation and bidding strategy review across all ad platforms. Evaluates spend distribution and bidding strategies.",
    note: null,
  },
  {
    ...
    category: "skills-ads",
    description:
      "Competitor ad intelligence analysis across Google, Meta, LinkedIn, TikTok, Microsoft, and Apple Ads.",
    note: null,
  },
  {
    ...
    category: "skills-ads",
    description:
      "Landing page quality assessment for paid advertising campaigns. Evaluates message match, page speed, mobile experience.",
    note: null,
  },
  {
    ...
    category: "skills-ads",
    description:
      "Cross-platform attribution health audit covering AdAttributionKit (iOS), CAPI, GA4, and server-side tracking.",
    note: null,
  },
  {
    ...
    category: "skills-ads",
    description:
      "Server-side tracking pipeline audit covering sGTM, Meta CAPI Gateway, Conversions API health, and event deduplication.",
    note: null,
  },
  {
    id: "skill:ads-create",
    ...
    category: "skills-ads",
    description:
      "Campaign concept and copy brief generator for paid advertising. Produces structured briefs with messaging frameworks.",
    note: null,
  },
  {
    ...
    category: "skills-ads",
    description:
      "AI image generation for paid ad creatives. Produces platform-sized ad images using Gemini.",
    note: "benötigt Gemini-Bild-API",
  },
  {
    ...
    category: "skills-ads",
    description:
      "Product photography enhancement for ad creatives. Generates 5 professional ad-ready shots from a product image.",
    note: "benötigt Gemini-Bild-API",
  },
  {
    id: "skill:ads-dna",
    ...
    category: "skills-ads",
    description:
      "Brand DNA extractor for paid advertising. Scans a website URL to extract visual identity, tone of voice, and brand elements.",
    note: null,
  },
  {
    id: "skill:ads-plan",
    ...
    category: "skills-ads",
    description:
      "Strategic paid advertising planning with industry-specific templates. Covers platform selection, campaign architecture, budget planning.",
    note: "langer Lauf",
  },
  {
    id: "skill:ads-math",
    ...
    category: "skills-ads",
    description:
      "PPC financial calculator and modeling tool. CPA, ROAS, CPL calculations, break-even analysis, budget scenarios.",
    note: null,
  },
  {
    id: "skill:ads-test",
  ...
  // --- ezy-reaktivierung (GEO-Reaktivierungsmaschine, 2026-07-20, manuell ergaenzt) ---
  {
    ...
    description:
      "Orchestrator der GEO-Reaktivierungsmaschine: Pipeline Pipedrive -> Kohorte -> GEO-Check -> Screenshot -> Outlook-Entwurf (nie Autoversand) -> Nachfass.",
    note: "langer Lauf",
  },
  {
    id: "skill:kohorte",
    ...
    category: "skills-reaktivierung",
    description:
      "Kohorten-Filter: Pipedrive-Datenmodell, Ein-/Ausschlussregeln (Bestandskunden, aktiver Verkauf, Absagen), Segmente, Dedupe.",
    note: null,
  },
  {
    id: "skill:geo-check",
    ...
    category: "skills-reaktivierung",
    description:
      "Ort/Kategorie via LLM, natuerlicher GEO-Prompt, Auftauchen-Check (Firma empfohlen = ueberspringen).",
    note: null,
  },
  {
    id: "skill:screenshot",
  ...
  },
  {
    ...
    category: "skills-reaktivierung",
    description:
      "Namens-Prozess, Mail-Vorlagen, Signatur, Outlook-Entwurf via Microsoft Graph, Alias-Round-Robin.",
  ...
  },
  {
    ...
    category: "skills-reaktivierung",
    description:
      "Verifikations-Checkliste nach jedem Batch (Namen, Branchen, Attachments, Verteilung).",
    note: null,
  },
];
