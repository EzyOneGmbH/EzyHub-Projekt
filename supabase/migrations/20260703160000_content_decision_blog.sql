-- ============================================================================
-- content_decision auf BLOG einschränken. Der Refresh-Radar (jetzt im Blog-Tab)
-- soll ausschließlich Blogartikel zeigen — keine Audits/Reports/Notizen.
-- Nur die View wird neu erstellt (Filter content_type='blog'); RPC/RLS bleiben.
-- ============================================================================
