-- ============================================================================
-- Peak-Fenster fuer die Decay-Regel begrenzen (Vorbereitung 180-Tage-Backfill,
-- 22.07.): Bisher war der Peak das Maximum ueber die GESAMTE Zeitreihe. Mit
-- laengerer Historie (6 Monate) enthielte er bei Saison-Kunden (Hotels) die
-- Winterspitze — im Sommer staende dann jeder Ski-Artikel auf refresh_decay,
-- obwohl das Saisonalitaet ist. Fix: Peak nur aus den letzten 120 Tagen
-- (Messpunkte captured_on >= heute-120). Chart/Historie bleiben unbegrenzt.
-- Spaltenliste der View unveraendert -> create or replace reicht, RPC bleibt.
-- ============================================================================
